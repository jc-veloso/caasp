...
User Function FATZZA01()
    ...
    While (cAliZZA)->(!Eof())
        ...
        If lOk
            ...
            U_ZZCALLBK("ZZA", cChvNFe, cSub, .T., cFilCb, cDocCb, "")
            nOk++
...
Static Function ZZA_MotorSaida(jJson)
    ...
    aRet := U_PI_SAIDA_X(aPrd, oHead, AllTrim(U_PI_STR_X(oHead,'_COD')), AllTrim(U_PI_STR_X(oHead,'_LOJA')), AllTrim(U_PI_STR_X(oHead,'_LEG')), AllTrim(U_PI_STR_X(oHead,'_SER')), AllTrim(U_PI_STR_X(oHead,'_FIL')), AllTrim(U_PI_STR_X(oHead,'_TAB')), U_PI_STR_X(oHead,'_TRANSF')=="S", AllTrim(U_PI_STR_X(oHead,'_NF')), AllTrim(U_PI_STR_X(oHead,'_SER')), AllTrim(U_PI_STR_X(oHead,'_LEG')), AllTrim(U_PI_STR_X(oHead,'_COND')))
